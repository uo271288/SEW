        ...
        public function buscarDatos(){
            ...
            if ($resultado->num_rows >= 1) {
                ...
                while($row = $resultado->fetch_assoc()) {
                    echo "<li>Nombre del usuario que realizó la prueba: " . $row["nombre"] . "</li>";
                    echo "<li>Apellidos del usuario que realizó la prueba: " . $row["apellidos"] . "</li>";
                    echo "<li>Email del usuario que realizó la prueba: " . $row["email"] . "</li>";
                    echo "<li>Telefono del usuario que realizó la prueba: " . $row["telefono"] . "</li>";
